...
**v4 功能已完成（2026-03-29）**：审核状态标签、回收站隐藏被拒绝、编辑页重新提交流程、审核邮件通知（通过/拒绝）、图形验证码（注册/改密/换绑/登录）
**v5 功能已完成（2026-04-03）**：撤回独立邮件模板（bot_revoked）、拒绝/撤回默认理由「内容违规」、保持登录（Remember Me，30天，remember_tokens表）
